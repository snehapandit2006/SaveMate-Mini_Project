...
import saveMateLogoImage from 'figma:asset/4d7c14c68e3799f5818cedf8d6f63b89d97eb538.png';
                ...
                <div>
                  ...
                  <Select 
                    ...
                    <SelectContent>
                      ...
                      <SelectItem value="other">Other (Type your bank name)</SelectItem>
                    </SelectContent>
                  </Select>
                  {selectedBankOption && (
                    <p className="text-xs text-gray-500 mt-1">Selected: {selectedBankOption}</p>
                  )}
                </div>
                
                {isOtherBank === true && (
                  <div className="space-y-2 p-4 bg-blue-50 rounded-lg border-2 border-blue-300">
                    <Label htmlFor="customBankName" className="text-blue-900">Enter Your Bank Name</Label>
                    <Input
                      id="customBankName"
                      ...
                      className="bg-white"
                    />
                    <p className="text-xs text-blue-700">Please enter the full name of your bank</p>
                  </div>
                )}
