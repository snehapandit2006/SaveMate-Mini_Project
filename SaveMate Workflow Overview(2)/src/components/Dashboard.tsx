...
import { TrendingDown, TrendingUp, Shield, Flame, Star, Lock, BarChart3, Home } from 'lucide-react';
...
export default function Dashboard({ onEmergencyMode, userData, onNavigateToGoals }: DashboardProps) {
